...
public class DefaultAircraftInjectorService implements AircraftInjectorService {
    ...
    public static final String RECEIVING_AIRCRAFT_DATA_FOR_AIRCRAFT_VIN = "[AIRCRAFT_INJECTOR_SERVICE] Receiving aircraft data for aircraft VIN: {}";
    public static final String AIRCRAFT_VIN_HAS_LANDED = "[AIRCRAFT_INJECTOR_SERVICE] Aircraft VIN: {} has landed";
    public static final String AIRCRAFT_VIN_IS_LANDING = "[AIRCRAFT_INJECTOR_SERVICE] Aircraft VIN: {} is landing";
    public static final String AT_ORIGIN_AIRFIELD = "[AIRCRAFT_INJECTOR_SERVICE] Aircraft VIN: {} still on ground at origin airfield";
    public static final String IS_DEPARTING = "[AIRCRAFT_INJECTOR_SERVICE] Aircraft VIN: {} is departing";
    public static final String IN_FLIGHT = "[AIRCRAFT_INJECTOR_SERVICE] Aircraft VIN: {} is now in flight";
